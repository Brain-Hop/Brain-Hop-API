...
- One explicit free vision model for image descriptions.
...
`IMAGE_DESCRIPTION_MODEL` is used only for image captions and should be a specific
free model with vision support.
